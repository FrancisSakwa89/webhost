...
def new_post():
  ...
  if form.validate_on_submit():
    ...
    for user in users:
        print(user.email)
        mail_message("New Post on the Web","email/sub_alert",user.email,user=user)  
...
def subscribe():
    ...
    if form.validate_on_submit():
        ...
        mail_message("Welcome To Webhost","email/sub",user.email,user=user)
